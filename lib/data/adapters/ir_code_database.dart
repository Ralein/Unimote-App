...
class IrCodeDatabase {
  ...
  static const Map<RemoteKey, int> necKeyCodes = {
    ...
    RemoteKey.num0: 0x00FF6897,
    RemoteKey.num1: 0x00FF30CF,
    RemoteKey.num2: 0x00FF18E7,
    RemoteKey.num3: 0x00FF7A85,
    RemoteKey.num4: 0x00FF10EF,
    RemoteKey.num5: 0x00FF38C7,
    RemoteKey.num6: 0x00FF5AA5,
    RemoteKey.num7: 0x00FF42BD,
    RemoteKey.num8: 0x00FF4AB5,
    RemoteKey.num9: 0x00FF52AD,
  };
